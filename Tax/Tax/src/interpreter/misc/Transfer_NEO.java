...
public class Transfer_NEO {
	...
	public static int materialForAnnuity;
	public static int singleLink;
	public static int doubleLink;
...
//		check if legal
		if(isLegal(transaction)){
			...
			if (SymbRegMOO_CO.dataFile.canRecord()) {
				SymbRegMOO_CO.dataFile.incDoubleLinkedList(doubleLink);
				SymbRegMOO_CO.dataFile.incMaterialForAnnuityList(materialForAnnuity);
				SymbRegMOO_CO.dataFile.incSingleLinkedList(singleLink);
			}
