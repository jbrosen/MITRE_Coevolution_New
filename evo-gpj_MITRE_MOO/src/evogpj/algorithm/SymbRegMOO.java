...
//        SEED = Long.parseLong("1394634935991");
...
//        System.exit(-1);
    ...
    */
    ...
    public static String getAuditScoreValuesFromPhenotype(String s) {
    	String str = s.split("AuditScores\\(")[1];
    	str = str.split("\\)")[0];
    	...
    	for (String num : str.split(",")) {
    		ret += (Double.parseDouble(num) / total) +", ";
    	}
    	return ret;
    }
...
//		VM output, with time stamp
		...
		SymbRegMOO srm;
		SymbRegMOO_CO srm_co = new SymbRegMOO_CO();
...
//				System.out.println(getAuditScoreValuesFromPhenotype(best.getPhenotype().getPhenotype()));
...
//					System.out.println(best.getPhenotype().getPhenotype());
